...
`--rna-strandness | -rna-strandness`: The strand-specific information used for HISAT2 mapping. For single-end reads, use F or R. For paired-end reads, use either FR or RF. Detailed descriptions of this option was available in [HISAT2 manual](https://ccb.jhu.edu/software/hisat2/manual.shtml). <br />
