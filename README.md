...
`-n | --outname_of_replicates | -outname_of_replicates`: The outnames of replicates from STEP1 for the RNA-editing results for each replicates from the same treatment. The separator between outnames should be comma, for example, "s1_rep1,s1_rep2,s1_rep3". <br />
